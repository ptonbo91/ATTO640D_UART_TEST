...
------------------------------------------------------------------
  ...
  constant DMA_WR_FIFO_CMD_DEPTH: positive:=2;
  ...
  signal DMA_W0_FIFO_CNT_CMD: std_logic_vector(DMA_WR_FIFO_CMD_DEPTH-1 downto 0);
  ...
  signal DMA_W0_FIFO_CNT: std_logic_vector(DMA_WR_FIFO_DEPTH-1 downto 0);
  ...
  signal DMA_W1_FIFO_CNT_CMD: std_logic_vector(DMA_WR_FIFO_CMD_DEPTH-1 downto 0);
  ...
  signal DMA_W1_FIFO_CNT: std_logic_vector(DMA_WR_FIFO_DEPTH-1 downto 0);
  ...
  signal DMA_W2_FIFO_CNT_CMD: std_logic_vector(DMA_WR_FIFO_CMD_DEPTH-1 downto 0);
  ...
  signal DMA_W2_FIFO_CNT: std_logic_vector(DMA_WR_FIFO_DEPTH-1 downto 0);
  ...
  constant DMA_RD_FIFO_CMD_DEPTH: positive:=3;
  ...
  signal DMA_R0_FIFO_CNT_CMD: std_logic_vector(DMA_RD_FIFO_CMD_DEPTH-1 downto 0);
  signal DMA_R1_FIFO_CNT_CMD: std_logic_vector(DMA_RD_FIFO_CMD_DEPTH-1 downto 0);
  signal DMA_R2_FIFO_CNT_CMD: std_logic_vector(DMA_RD_FIFO_CMD_DEPTH-1 downto 0);
  signal DMA_R3_FIFO_CNT_CMD: std_logic_vector(DMA_RD_FIFO_CMD_DEPTH-1 downto 0);
  ...
  signal DMA_R0_FIFO_CNT: std_logic_vector(DMA_RD_FIFO_DEPTH-1 downto 0);
  signal DMA_R1_FIFO_CNT: std_logic_vector(DMA_RD_FIFO_DEPTH-1 downto 0);
  signal DMA_R2_FIFO_CNT: std_logic_vector(DMA_RD_FIFO_DEPTH-1 downto 0);
  signal DMA_R3_FIFO_CNT: std_logic_vector(DMA_RD_FIFO_DEPTH-1 downto 0);
...
--ATTRIBUTE MARK_DEBUG of DMA_W0_EMPTY_RD_S : SIGNAL IS "TRUE"; 
--ATTRIBUTE MARK_DEBUG of DMA_W1_EMPTY_RD_S : SIGNAL IS "TRUE"; 
--ATTRIBUTE MARK_DEBUG of DMA_W2_EMPTY_RD_S : SIGNAL IS "TRUE"; 
----ATTRIBUTE MARK_DEBUG of DMA_W0_EMPTY_RD_CMD_S : SIGNAL IS "TRUE"; 
----ATTRIBUTE MARK_DEBUG of DMA_W1_EMPTY_RD_CMD_S : SIGNAL IS "TRUE"; 
----ATTRIBUTE MARK_DEBUG of DMA_W2_EMPTY_RD_CMD_S : SIGNAL IS "TRUE"; 
--ATTRIBUTE MARK_DEBUG of DMA_W0_EMPTY_RD_M : SIGNAL IS "TRUE"; 
--ATTRIBUTE MARK_DEBUG of DMA_W1_EMPTY_RD_M : SIGNAL IS "TRUE"; 
--ATTRIBUTE MARK_DEBUG of DMA_W2_EMPTY_RD_M : SIGNAL IS "TRUE"; 
--ATTRIBUTE MARK_DEBUG of W0_READY_FSM : SIGNAL IS "TRUE"; 
--ATTRIBUTE MARK_DEBUG of W1_READY_FSM : SIGNAL IS "TRUE"; 
--ATTRIBUTE MARK_DEBUG of W2_READY_FSM : SIGNAL IS "TRUE"; 


-------
begin
-------
  DMA_WRBURST_temp  <= DMA_WRBURST_TEMP;
...
--xpm_cdc_single_inst_W0_CMD: xpm_cdc_single
--  generic map (
...
--  )
--  port map (
--     src_clk  => DMA_CLK,  -- optional; required when SRC_INPUT_REG = 1
--     src_in   => DMA_W0_EMPTY_RD_CMD,
--     dest_clk => DMA_W0_CLK,
--     dest_out => DMA_W0_EMPTY_RD_CMD_S
--  );


--xpm_cdc_single_inst_W0_DATA: xpm_cdc_single
--  generic map (
--     DEST_SYNC_FF   => 4, -- integer; range: 2-10
--     INIT_SYNC_FF   => 0, -- integer; 0=disable simulation init values, 1=enable simulation init values
--     SIM_ASSERT_CHK => 0, -- integer; 0=disable simulation messages, 1=enable simulation messages
...
--  port map (
--     src_clk  => DMA_CLK,  -- optional; required when SRC_INPUT_REG = 1
--     src_in   => DMA_W0_EMPTY_RD,
--     dest_clk => DMA_W0_CLK,
--     dest_out => DMA_W0_EMPTY_RD_S
--  );
...
--xpm_cdc_single_inst_W1_CMD: xpm_cdc_single
--  generic map (
--     DEST_SYNC_FF   => 4, -- integer; range: 2-10
--     INIT_SYNC_FF   => 0, -- integer; 0=disable simulation init values, 1=enable simulation init values
--     SIM_ASSERT_CHK => 0, -- integer; 0=disable simulation messages, 1=enable simulation messages
...
--  port map (
--     src_clk  => DMA_CLK,  -- optional; required when SRC_INPUT_REG = 1
--     src_in   => DMA_W1_EMPTY_RD_CMD,
--     dest_clk => DMA_W1_CLK,
--     dest_out => DMA_W1_EMPTY_RD_CMD_S
--  );


--xpm_cdc_single_inst_W1_DATA: xpm_cdc_single
--  generic map (
--     DEST_SYNC_FF   => 4, -- integer; range: 2-10
--     INIT_SYNC_FF   => 0, -- integer; 0=disable simulation init values, 1=enable simulation init values
--     SIM_ASSERT_CHK => 0, -- integer; 0=disable simulation messages, 1=enable simulation messages
...
--  port map (
--     src_clk  => DMA_CLK,  -- optional; required when SRC_INPUT_REG = 1
--     src_in   => DMA_W1_EMPTY_RD,
--     dest_clk => DMA_W1_CLK,
--     dest_out => DMA_W1_EMPTY_RD_S
--  );

--xpm_cdc_single_inst_W1: xpm_cdc_single
--  generic map (
--     DEST_SYNC_FF   => 4, -- integer; range: 2-10
--     INIT_SYNC_FF   => 0, -- integer; 0=disable simulation init values, 1=enable simulation init values
--     SIM_ASSERT_CHK => 0, -- integer; 0=disable simulation messages, 1=enable simulation messages
...
--xpm_cdc_single_inst_W2_CMD: xpm_cdc_single
--  generic map (
--     DEST_SYNC_FF   => 4, -- integer; range: 2-10
--     INIT_SYNC_FF   => 0, -- integer; 0=disable simulation init values, 1=enable simulation init values
--     SIM_ASSERT_CHK => 0, -- integer; 0=disable simulation messages, 1=enable simulation messages
...
--  port map (
--     src_clk  => DMA_CLK,  -- optional; required when SRC_INPUT_REG = 1
--     src_in   => DMA_W2_EMPTY_RD_CMD,
--     dest_clk => DMA_W2_CLK,
--     dest_out => DMA_W2_EMPTY_RD_CMD_S
--  );


--xpm_cdc_single_inst_W2_DATA: xpm_cdc_single
--  generic map (
--     DEST_SYNC_FF   => 4, -- integer; range: 2-10
--     INIT_SYNC_FF   => 0, -- integer; 0=disable simulation init values, 1=enable simulation init values
--     SIM_ASSERT_CHK => 0, -- integer; 0=disable simulation messages, 1=enable simulation messages
...
--  port map (
--     src_clk  => DMA_CLK,  -- optional; required when SRC_INPUT_REG = 1
--     src_in   => DMA_W2_EMPTY_RD,
--     dest_clk => DMA_W2_CLK,
--     dest_out => DMA_W2_EMPTY_RD_S
--  );


--xpm_cdc_single_inst_W2: xpm_cdc_single
--  generic map (
--     DEST_SYNC_FF   => 4, -- integer; range: 2-10
--     INIT_SYNC_FF   => 0, -- integer; 0=disable simulation init values, 1=enable simulation init values
--     SIM_ASSERT_CHK => 0, -- integer; 0=disable simulation messages, 1=enable simulation messages
...
--probe0(31 downto 26)<= std_logic_vector(DMA_W0_FIFO_CNT);
...
--probe0(48 downto 43)<= std_logic_vector(DMA_W2_FIFO_CNT);
...
--probe0(56 downto 55) <= DMA_W0_TRNSCN;
--probe0(58 downto 57) <= DMA_W2_TRNSCN;
----probe0(59) <= DMA_W0_CLK;
----probe0(60) <= DMA_W0_RST;
----probe0(61) <= DMA_W2_CLK;
----probe0(62) <= DMA_W2_RST;
--probe0(62 downto 59)<= (others=>'0');
--probe0(65 downto 63) <= std_logic_vector(to_unsigned(W0_READY_FSM_t'POS(W0_READY_FSM), 3));
--probe0(68 downto 66) <= std_logic_vector(to_unsigned(W1_READY_FSM_t'POS(W1_READY_FSM), 3));
--probe0(71 downto 69) <= std_logic_vector(to_unsigned(W2_READY_FSM_t'POS(W2_READY_FSM), 3));
--probe0(72) <= DMA_W0_EMPTY_RD_M;
--probe0(73) <= DMA_W1_EMPTY_RD_M;
--probe0(74) <= DMA_W2_EMPTY_RD_M;
--probe0(75) <= DMA_W0_EMPTY_RD_S;
--probe0(76) <= DMA_W1_EMPTY_RD_S;
--probe0(77) <= DMA_W2_EMPTY_RD_S;
--probe0(127 downto 78)<= (others=>'0');
